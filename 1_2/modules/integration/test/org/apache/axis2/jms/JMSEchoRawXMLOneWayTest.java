...
/**
 * This class contains unit tests for the jms implementation. Embedded 
 * ActiveMQ broker is used as JMS provider.
 */
...
public class JMSEchoRawXMLOneWayTest extends TestCase {
	...
	private static final boolean USE_EMBEDDED_BROKER = true; // If false, standalone ActiveMQ broker is required. 
	...
	/**
	 * Adds JMS configuration to the service. These parameters are normally
	 * loaded from service.xml
	 */ 
	...
	/**
	 * Calls 'echoOMElementNoResponse' operation of the EchoXMLService service 
	 * in one-way fashion. Therefore, we don't expect a response from the 
	 * service.
	 * 
	 * When this test sends message to the queue, the server retrieves 
	 * and delegates it to the 'echoOMElementNoResponse' method of Echo class.
	 */
