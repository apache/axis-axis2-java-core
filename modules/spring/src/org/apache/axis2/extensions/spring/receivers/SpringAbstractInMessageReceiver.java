 ...
 */
public abstract class SpringAbstractInMessageReceiver extends SpringAbstractMessageReceiver {
	private static final Log log = LogFactory.getLog(SpringAbstractInMessageReceiver.class);
