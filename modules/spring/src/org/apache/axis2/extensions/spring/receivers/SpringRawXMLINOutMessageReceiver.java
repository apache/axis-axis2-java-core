...
public class SpringRawXMLINOutMessageReceiver extends
		SpringAbstractInOutSyncMessageReceiver {

    /**
     * Field log
     */
    private static final Log log = LogFactory.getLog(SpringRawXMLINOutMessageReceiver.class);

    /**
     * Constructor RawXMLProvider
     */
    public SpringRawXMLINOutMessageReceiver() {
    }
