 ...
 */
public abstract class SpringAbstractInOutAsyncMessageReceiver extends SpringAbstractMessageReceiver {
	private static final Log log = LogFactory.getLog(SpringAbstractInOutAsyncMessageReceiver.class);
