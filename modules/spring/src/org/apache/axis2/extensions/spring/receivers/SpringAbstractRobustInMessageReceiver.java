 ...
 */
public abstract class SpringAbstractRobustInMessageReceiver extends SpringAbstractMessageReceiver {
	private static final Log log = LogFactory.getLog(SpringAbstractRobustInMessageReceiver.class);
