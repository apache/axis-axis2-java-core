...
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\stax-1.1.1-dev.jar"
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\stax-api-1.0.jar"
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\geronimo-spec-activation-1.0.2-rc3.jar
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\axis-wsdl4j-1.2.jar        
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\geronimo-spec-javamail-1.3.1-rc3.jar
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\xbean-2.0.0-beta1.jar
AXIS2_CLASS_PATH="%CLASS_PATH";"%AXIS_HOME%\lib\stax-api-1.0.jar
