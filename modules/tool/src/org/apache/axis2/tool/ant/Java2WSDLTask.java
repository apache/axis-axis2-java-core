...
public class Java2WSDLTask extends Task {
    ...
    private Map fillOptionMap() {
        ...
        addToOptionMap(	optionMap, 
        				CommandLineOptionConstants.Java2WSDLConstants.CLASSNAME_OPTION,
                        className);
        
        // Output location
        addToOptionMap(	optionMap, 
                		CommandLineOptionConstants.Java2WSDLConstants.OUTPUT_LOCATION_OPTION,
                        outputLocation);

        // Classpath URI
        addToOptionMap(	optionMap, 
                		CommandLineOptionConstants.Java2WSDLConstants.CLASSPATH_OPTION,
                		classpathURI);
        
        // Target namespace
        addToOptionMap(	optionMap,
                		CommandLineOptionConstants.Java2WSDLConstants.TARGET_NAMESPACE_OPTION,
                		targetNamespace);

        // Target namespace prefix
        addToOptionMap(	optionMap,
        				CommandLineOptionConstants.Java2WSDLConstants.TARGET_NAMESPACE_PREFIX_OPTION,
        				targetNamespacePrefix);

        // Schema target namespace
        addToOptionMap(	optionMap,
        				CommandLineOptionConstants.Java2WSDLConstants.SCHEMA_TARGET_NAMESPACE_OPTION,
        				schemaTargetNamespace);

        // Schema target namespace prefix
        addToOptionMap(	optionMap,
                		CommandLineOptionConstants.Java2WSDLConstants.SCHEMA_TARGET_NAMESPACE_PREFIX_OPTION,
                		schemaTargetNamespacePrefix);

        // Service name
        addToOptionMap(	optionMap,
        				CommandLineOptionConstants.Java2WSDLConstants.SERVICE_NAME_OPTION,
        				serviceName);

        // Output file name
        addToOptionMap(	optionMap,
                		CommandLineOptionConstants.Java2WSDLConstants.OUTPUT_FILENAME_OPTION,
                		outputFileName);
    ...
    private void addToOptionMap(Map map, String option, String value) {
    	if (value != null) {
    		map.put(option,
                    new CommandLineOption(option, getStringArray(value)));
    	}
    }
