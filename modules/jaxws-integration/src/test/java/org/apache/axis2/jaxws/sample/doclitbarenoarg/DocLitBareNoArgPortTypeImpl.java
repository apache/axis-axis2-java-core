...
public class DocLitBareNoArgPortTypeImpl implements DocLitBareNoArgPortType {
    ...
    /* (non-Javadoc)
     * @see org.apache.axis2.jaxws.sample.doclitbarenoarg.sei.DocLitBareNoArgPortType#twoWayEmpty()
     */
    public String twoWayEmpty() {
        return "org.apache.axis2.jaxws.sample.doclitbarenoarg.DocLitBareNoArgPortTypeImpl.twoWayEmpty";
    }
