...
public class SOAPFaultImpl extends SOAPBodyElementImpl implements SOAPFault {
     ...
     * specification. This element is mandatory in SOAP 1.1. Because the fault code is 
     * required to be a QName it is preferable to use the setFaultCode(Name)form of this method.
     * 
     * @param faultCode - a String giving the fault code to be set. It must be of the form
     *                   "prefix:localName" where the prefix has been defined in a 
     *                   namespace declaration.
     * @throws SOAPException - if there was an error in adding the faultCode to the underlying 
     *         XML tree.
...
//        	}
    ...
    /**
     * Sets this SOAPFault object with the given fault actor.The fault actor is the recipient 
     * in the message path who caused the fault to happen. If this SOAPFault supports SOAP 1.2 
     * then this call is equivalent to setFaultRole(String)
     * 
     * @param faultActor - a String identifying the actor that caused this SOAPFault object
     * @throws SOAPException - if there was an error in adding the faultActor to the underlying
     * XML tree.
     */
    ...
    /**
     * Sets this SOAPFault object with the given fault code.Fault codes, which give 
     * information about the fault, are defined in the SOAP 1.1 specification. A
     * fault code is mandatory and must be of type QName. This method provides a convenient 
     ...
     * If this SOAPFault is part of a message that supports SOAP 1.2 then this call 
     * is equivalent to:
     *  addFaultReasonText(faultString, Locale.getDefault());
     *@param faultString - a String giving an explanation of the fault
     *@throws SOAPException - if there was an error in adding the faultString to the underlying
     *        XML tree.
     *@see getFaultString()
     */
     ...
     * If this SOAPFault is part of a message that supports SOAP 1.2 then this 
     ...
     * return locale;
     * 
     * @return a Locale object indicating the native language of the fault 
     *         string or null if no locale was specified
     * @since SAAJ 1.2
     ...
     * will be replaced with text. The locale parameter should not be null
     * Code sample:
     * SOAPFault fault = ...;
     ...
     *         java.lang.UnsupportedOperationException - if this message does not support
     *         the SOAP 1.2 concept of Subcode.
     */
     ...
     * @throws java.lang.UnsupportedOperationException - if this message does not support
    ...
    /**
     * Returns an Iterator over a distinct sequence of Locales for which there are associated 
     * Reason Text items. Any of these Locales can be used in a call to getFaultReasonText in 
     * order to obtain a localized version of the Reason Text string.
     * 
     * @return an Iterator over a sequence of Locale objects for which there are associated 
     * Reason Text items.
    ...
    /**
     * Returns the Reason Text associated with the given Locale. If more than one such Reason 
     * Text exists the first matching Text is returned
     * 
	 ...
	 *@return an Iterator that accesses a sequence of QNames. This Iterator should not support
	 *        the optional remove method. The order in which the Subcodes are returned 
	 *        reflects the hierarchy of Subcodes present in the fault from top to bottom.
	 * 
	 *@throws java.lang.UnsupportedOperationException - if this message does not support
	 *        the SOAP 1.2 concept of Subcode.
     */
     ...
     * getFaultSubcodes will return an empty iterator until a call to appendFaultSubcode is
     * made.
     * @throws java.lang.UnsupportedOperationException - if this message does not support
     *         the SOAP 1.2 concept of Subcode.
     */
    ...
    /**
     * Sets this SOAPFault object with the given fault code. It is preferable to use 
     * this method over setFaultCode(Name)
     * 
     * @param faultCodeQName - a QName object giving the fault code to be set. It must 
     * be namespace qualified.
     * 
     * @throws SOAPException - if there was an error in adding the faultcode element to 
     ...
     * @throws SOAPException - if there was an error in setting the Node for this SOAPFault 
     *         object.
     *         java.lang.UnsupportedOperationException - if this message does not support
     *         the SOAP 1.2 concept of Fault Node.
     * @since SAAJ 1.3
