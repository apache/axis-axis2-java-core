...
public abstract class AbstractJAXBAttachmentMarshaller extends AttachmentMarshaller {

    private static final Log log = LogFactory.getLog(AbstractJAXBAttachmentMarshaller.class);
     ...
     * @param writer
     */
    public AbstractJAXBAttachmentMarshaller(MessageContext msgContext, XMLStreamWriter writer) {
     ...
     */
    protected abstract boolean isMTOMEnabled();
    
    /**
     * Indicate on the context that SWA attachments are encountered
     */
    protected abstract void setDoingSWA();
     ...
     * @param cid
     */
    protected abstract void addDataHandler(DataHandler dh, String cid);
}
