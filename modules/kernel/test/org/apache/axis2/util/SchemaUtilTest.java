...
public class SchemaUtilTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        /**
         *The structure which is serialized in the url. We try to recreate the structure at the
         * server side.
         *<year>2006</year>
         *<month>11</month>
         *<day>18</day>
    ...
    public void testCreateHttpLocationParameterMap() {
        ...
        SchemaUtil.extractParametersFromQueryPart(httpLocation, "&", multipleEntryHashMap,
                                                  parameterMap);
        assertEquals("ABCD", multipleEntryHashMap.get("FirstName"));
        assertEquals("DCBA", multipleEntryHashMap.get("LastName"));
    }

    public void testServerSideURLTemplateHandlingOne() throws AxisFault {
        String template = "datespace/{year}/{month}/{day}/{time}-{time}.html";
        String actualPath = "http://example.org/datespace/2006/11/18/16:40:00-20:00:42.html";
    ...
    public void testServerSideURLTemplateHandlingTwo() throws AxisFault {
        ...
        String actualPath =
                "http://example.org/datespace/2006/11.html?day=18;start=16:40:00;end=20:00:42";
        ...
        SchemaUtil.extractParametersFromQueryPart(templatedQueryParams, ";", multipleEntryHashMap,
                                                  parameterMap);
