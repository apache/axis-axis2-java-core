...
public class ServiceRefType {
    ...
    @XmlElement(name = "service-ref-name", namespace = "http://java.sun.com/xml/ns/javaee",
                required = true)
    protected JndiNameType serviceRefName;
    @XmlElement(name = "service-interface", namespace = "http://java.sun.com/xml/ns/javaee",
                required = true)
    ...
    @XmlElement(name = "port-component-ref", namespace = "http://java.sun.com/xml/ns/javaee",
                required = true)
