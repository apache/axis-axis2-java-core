...
:gotHome
if EXIST "%AXIS_HOME%\lib\axis2-0.91.jar" goto okHome
...
set AXIS2_CLASS_PATH= %AXIS2_CLASS_PATH%;"%AXIS_HOME%\lib\stax-1.1.1-dev.jar"
...
set AXIS2_CLASS_PATH= %AXIS2_CLASS_PATH%;"%AXIS_HOME%\lib\commons-httpclient-3.0-rc2.jar"
