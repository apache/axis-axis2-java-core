...
public class MtomSample12PortProxy {
    ...
    public class Descriptor {
        private MtomSampleService12 _service = null;
        private MtomSample12 _proxy = null;
        private Dispatch<Source> _dispatch = null;

        public Descriptor() {
            _service = new MtomSampleService12();
            initCommon();
        }

        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new MtomSampleService12(wsdlLocation, serviceName);
            initCommon();
        }
    ...
    public MtomSample12PortProxy(URL wsdlLocation) {
        _descriptor = new Descriptor(wsdlLocation, new QName("http://org/apache/axis2/jaxws/samples/mtom/", "MtomSampleService12"));
    }
