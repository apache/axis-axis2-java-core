 ...
 * protocol-bindings are used to specify whether the handlers in handler-chain are for a service,
 * port or protocol binding. If none of these choices are specified with the handler-chain element
 * then the handlers specified in the handler-chain will be applied on everything.
 * <p/>
 * <p/>
 * <p/>
